...
<div class="my-2">
    ...
    <a class="tag_data" href="{{ route('subcategory_by_id.index', [@$view_post->category->id, $view_post->subcategory->slug]) }}"><i class="fa-solid fa-tags"></i> {{$view_post->category->name ?? '' }}</a>
</div>
